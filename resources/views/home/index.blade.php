...
<!--search jQuery-->
	<script src="{{asset('script.js')}script.jsript>
<!--search jQuery-->
...
<!-- cart -->
  <!--start-rate-->
<script src="{{asset('frontend/js/simpleCart.min.js')}}js/jstarbox.js"></script>
				...
				<div class="container">
					<div class="logo-nav">
						<div class="logo-nav-left">
							<h1><a href="index.blade.php">Nhà sách Đà Nẵng <span>chi nhánh 1</span></a></h1>
						</div>
						<div class="logo-nav-left1">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									<li class="active"><a href="index.blade.php" class="act">Home</a></li>
									<!-- Mega Menu -->
									<li class="dropdown">
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
												<div class="grid-img">
													<img  src="{{asset('frontend/images/p6.jpg')}}" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal2">
												...
												<div class="grid-img">
													<img  src="{{asset('frontend/images/p8.jpg')}}" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal4">
												<div class="grid-img">
													<img  src="{{asset('frontend/images/p11.jpg')}}" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													...
													<div  class="grid-arrival">
														<figure>		
															<a href="single.html">
																...
																<div class="grid-img">
																	<img  src="{{asset('frontend/images/p17.jp')}}g" class="img-responsive"  alt="">
																</div>			
															</a>		
														</figure>	
													</div>
													...
													<div  class="grid-arrival">
														<figure>		
															<a href="single.html">
																...
																<div class="grid-img">
																	<img  src="{{asset('frontend/images/p23.jp')}}g" class="img-responsive"  alt="">
																</div>			
															</a>		
														</figure>	
													</div>
							...
							<div class="footer-grids">
								...
								<div class="col-md-3 footer-grid">
									...
									<ul>
										...
										<li><a href="codes.html">Sales</a></li>
										<li><a href="mail.html">About us</a></li>
										<li><a href="products1.html">Contact Us</a></li>
									</ul>
								</div>
