								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="show_book.blade.php"><img class="img-responsive " src="images/r.jpg" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="show_book.blade.php">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="show_book.blade.php"><img class="img-responsive " src="images/r1.jpg" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="show_book.blade.php">Duis aute irure </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="show_book.blade.php"><img class="img-responsive " src="images/r2.jpg" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="show_book.blade.php">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="show_book.blade.php"><img class="img-responsive " src="images/r3.jpg" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="show_book.blade.php">Ut enim ad minim </a></h6>
											...
											<div class="product-tab">
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														...
														<div class="women">
															<h6><a href="show_book.blade.php">Sed ut perspiciatis unde</a></h6>
